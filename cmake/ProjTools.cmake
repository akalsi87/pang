...
# -- add_link_lib: Add link lib to target
function(add_link_lib tgt lib)
    if (MSVC)
      set(new_flags ${lib})
    else()
      set(new_flags -l${lib})
    endif()
    get_target_property(curr_flags ${tgt} LINK_LIBRARIES)
    if(curr_flags)
      set(new_flags "${curr_flags} ${new_flags}")
    endif(curr_flags)
    set_property(TARGET ${tgt} PROPERTY LINK_LIBRARIES ${new_flags})
endfunction(add_link_lib)
